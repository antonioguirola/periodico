        ...
        <section class="seccionPrincipal">
            ...
            <section class="seccionNoticiasIzq">
                ...
                <article class="cuerpoNoticia"><?php require_once '../funcionesGenerales.php';mostrarNoticiasRelacionadas();?>                      
                    ...
                    <h1 class="titulo" onmouseover="abrirDialogo();">Detenido en Barcelona el responsable del mayor ciberataque 'DDOS' de la historia</h1>

                    <img src="detenido-barcelona-responsable-20130501/detenido-barcelona-responsable-20130501.jpg">

                    <h1 class="subtitulo">Se trata de Sven Olaf Kamphuis, ciudadano holandés de 35 años.</h1>

                    <h1 class="subtitulo">Fue arrestado en 'bunker informático' desde el que llegó a conceder entrevistas.</h1>

                    <h1 class="subtitulo">Los 'ciberataques' se iniciaron en Holanda y llegaron a Reino Unido y EE UU.</h1>


                    <p>Agentes de la Policía Nacional han detenido en Granollers (Barcelona) a Sven Olaf Kamphuis, un activista holandés de 35 años como responsable del mayor ciberataque de denegación de servicios DDOS de la historia que colapsó Internet, según informa el cuerpo policial en un comunicado.</p>

                    <p>Las investigaciones se iniciaron en Holanda después de que en marzo se detectaran una serie de ataques informáticos contra una compañía anti-spam, que también afectó a Estados Unidos y Reino Unido.</p>

                    <p>Considerado el mayor ciberataque del mundo, colapsó la red por los intentos de hacerse con el control de los servidores afectados.</p>

                    <p>El ataque DDOS provoca una sobrecarga de los recursos del sistema informático hasta que la red se ralentiza por los accesos masivos a la misma.</p>

                    <p>Los intentos por recuperar el control por parte de los servidores asaltados y los ataques de los ciberactivistas provocaron tal ocupación de la red que ésta se vio afectada a nivel mundial.</p>

                    <p>Iniciada la investigación policial, los agentes pudieron atribuir la responsabilidad de los ataques al grupo stophaus, cuyo organizador, un hombre nacido en Alkmaar (Holanda), residía en España, en un domicilio de Granollers.</p>
